...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Nov-2019 às 00:29
...
--
-- Estrutura da tabela `bookauthors`
--
...
--
-- Extraindo dados da tabela `bookauthors`
--
...
--
-- Estrutura da tabela `bookauthorsbooks`
--
...
--
-- Extraindo dados da tabela `bookauthorsbooks`
--
...
--
-- Estrutura da tabela `bookcategories`
--
...
--
-- Extraindo dados da tabela `bookcategories`
--
...
--
-- Estrutura da tabela `bookcategoriesbooks`
--
...
--
-- Extraindo dados da tabela `bookcategoriesbooks`
--
...
--
-- Estrutura da tabela `bookcustomers`
--
...
--
-- Extraindo dados da tabela `bookcustomers`
--

INSERT INTO `bookcustomers` (`custID`, `fname`, `lname`, `email`, `city`, `cep`, `state`, `street`, `numero`, `referencia`) VALUES
(6, 'admin', 'admin', 'admin@gmail.com', 'Itajuba', '375120000', 'MG', 'Rua Antonio Rodrigues de Oliveira', 126, 'Perto da padaria rainha');

-- --------------------------------------------------------

--
-- Estrutura da tabela `bookdescriptions`
--
...
--
-- Extraindo dados da tabela `bookdescriptions`
--
...
--
-- Estrutura da tabela `bookorderitems`
--
...
--
-- Estrutura da tabela `bookorders`
--
...
--
-- Índices para tabela `bookauthors`
--
ALTER TABLE `bookauthors`
  ADD PRIMARY KEY (`AuthorID`);

--
-- Índices para tabela `bookauthorsbooks`
--
ALTER TABLE `bookauthorsbooks`
  ADD PRIMARY KEY (`ISBN`,`AuthorID`);

--
-- Índices para tabela `bookcategories`
--
ALTER TABLE `bookcategories`
  ADD PRIMARY KEY (`CategoryID`);

--
-- Índices para tabela `bookcategoriesbooks`
--
ALTER TABLE `bookcategoriesbooks`
  ADD PRIMARY KEY (`CategoryID`,`ISBN`);

--
-- Índices para tabela `bookcustomers`
--
ALTER TABLE `bookcustomers`
  ADD PRIMARY KEY (`custID`);

--
-- Índices para tabela `bookdescriptions`
--
...
--
-- Índices para tabela `bookorderitems`
--
...
--
-- Índices para tabela `bookorders`
--
...
--
-- Limitadores para a tabela `bookorderitems`
--
ALTER TABLE `bookorderitems`
  ADD CONSTRAINT `bookorderitems_ibfk_1` FOREIGN KEY (`orderID`) REFERENCES `bookorders` (`orderID`),
  ADD CONSTRAINT `bookorderitems_ibfk_2` FOREIGN KEY (`ISBN`) REFERENCES `bookdescriptions` (`ISBN`);
COMMIT;
